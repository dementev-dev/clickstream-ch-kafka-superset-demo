...
Ниже показаны ключевые поля `Page Funnel`; в реальном файле после них есть ещё
визуальные параметры funnel — схема цветов, легенда, подписи и формат чисел:
...
```python
{
    ...
    "params": {
        ...
        # Дальше в файле идут визуальные параметры funnel.
    }
}
```
