...
> (один `click_id` на визит, путь по страницам, монотонное время), но популяция
> возвращающихся пользователей и полноценное состояние активных визитов ещё
...
- Держим целевую интенсивность `events/min` без крупных минутных batch: тик
  набирается из одного или нескольких визитов до рассчитанного бюджета событий
